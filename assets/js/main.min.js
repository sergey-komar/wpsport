...
const sortBtn = document.querySelector('.sorting-desc__title');
const sortLink = document.querySelector('.sorting-desc__list');

if(sortBtn && sortLink){
    sortBtn.addEventListener('click', () => {
        sortLink.classList.toggle('sorting-show');
    })
}
