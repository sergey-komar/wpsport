...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<div cellspacing="0" class="shop_table shop_table_responsive">
		...
		<div class="cart-subtotal">
			<div class="cart-subtotal__title"><?php esc_html_e( 'Subtotal:', 'woocommerce' ); ?></div>
			<div class="cart-subtotal__price" data-title="<?php esc_attr_e( 'Subtotal', 'woocommerce' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></div>
		</div>
		...
		<?php if ( WC()->cart->needs_shipping() && WC()->cart->show_shipping() ) : ?>
			...
			<div class="cart_totals_shipping">
		...
		<div class="order-total">
			<div class="order-total__title"><?php esc_html_e( 'Total', 'woocommerce' ); ?></div>
